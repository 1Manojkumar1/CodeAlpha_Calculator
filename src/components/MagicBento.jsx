...
const ParticleCard = ({
  ...
  useEffect(() => {
    ...
    const handleMouseEnter = () => {
      ...
      if (!keepParticles) animateParticles();
    ...
    const handleMouseLeave = () => {
      ...
      if (!keepParticles) clearAllParticles();
  ...
  }, [animateParticles, clearAllParticles, disableAnimations, enableTilt, enableMagnetism, clickEffect, glowColor, keepParticles]);

  useEffect(() => {
    if (disableAnimations || !keepParticles || !cardRef.current) return;
    isHoveredRef.current = true;
    animateParticles();
  }, [disableAnimations, keepParticles, animateParticles]);
...
export { ParticleCard, GlobalSpotlight, DEFAULT_GLOW_COLOR };
